        ...
        <div>
            ...
            >
                ...
                <Row style={{ marginTop: '20px' }} gutter={5}>
                    ...
                    <Col span={6}>
                        <div style={{ fontFamily: 'Noto Sans KR', fontStyle: 'normal', fontWeight: 'bold', fontSize: '16px', lineHeight: '20px', color: '#5F5F5F', mixBlendMode: 'normal' }}>학교 분위기</div>
                        <div style={{ marginTop: '15px' }}>4/5</div>
                    </Col>
                    <Col span={6}>
                        <div style={{ fontFamily: 'Noto Sans KR', fontStyle: 'normal', fontWeight: 'bold', fontSize: '16px', lineHeight: '20px', color: '#5F5F5F', mixBlendMode: 'normal' }}>강의 전달력</div>
                        <div style={{ marginTop: '15px' }}>3/5</div>
                    </Col>
                    <Col span={6}>
                        <div style={{ fontFamily: 'Noto Sans KR', fontStyle: 'normal', fontWeight: 'bold', fontSize: '16px', lineHeight: '20px', color: '#5F5F5F', mixBlendMode: 'normal' }}>만족도</div>
                ...
                <Row style={{ marginTop: '30px' }}>
                    <Col span={10}>
                        <div style={{ fontFamily: 'Noto Sans KR', fontStyle: 'normal', fontWeight: 'bold', fontSize: '16px', lineHeight: '20px', color: '#5F5F5F', mixBlendMode: 'normal' }}>로스쿨에 바라는 점</div>
                        <div style={{ marginTop: '15px' }}>
